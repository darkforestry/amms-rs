...
async fn main() -> eyre::Result<()> {
    ...
    let selector = IUniswapV2Factory::allPairsCall::SIGNATURE.to_string();
    println!("{}", uv2.abi.functions.contains_key(&selector));

    for selector in IUniswapV2FactoryCalls::SELECTORS {
