...
// import "../src/Filters/GetWethValueInPoolBatchRequest.sol";
...
//         GetWethValueInPoolBatchRequest data = new GetWethValueInPoolBatchRequest(
//                 pools,
//                 dexes,
//                 dexIsUniV3,
//                 weth,
...
//         uint256[] memory weth_values = abi.decode(
//             address(data).code,
//             (uint256[])
//         );
